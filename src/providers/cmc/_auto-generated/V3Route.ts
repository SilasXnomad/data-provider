...
export namespace V3 {
   ...
   */
  export namespace GetV3FearandgreedHistorical {
    ...
    export type ResponseBody = FearAndGreedHistoricalResponseModel;
  }
   ...
   */
  export namespace GetV3FearandgreedLatest {
    export type RequestParams = {};
    export type RequestQuery = {};
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = FearAndGreedLatestResponseModel;
  }
   ...
   */
  export namespace GetV3CryptocurrencyQuotesHistorical {
    export type RequestParams = {};
    export type RequestQuery = {
      /**
